...
# agy shows a workspace-trust prompt in a directory it has never seen, but its
# process is already running behind that prompt, which is all this probe reads.
